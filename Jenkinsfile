pipeline {
    ...
    stages {
        stage("Clone ATM Machine API from Github") {
            steps {
                echo "Cloning ATM Machine API from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/atm-machine-api'
                echo "Cloning ATM Machine API from Github. Success!"
            }
        }
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker tag ama:latest elleined/ama:latest'
                sh 'docker push elleined/ama:latest'
