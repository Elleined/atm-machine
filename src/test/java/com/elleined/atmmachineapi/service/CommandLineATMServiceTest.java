...
class CommandLineATMServiceTest {
    ...
    void deposit() {
        ...
        // Calling the method
        commandLineATMService.deposit(user, new BigDecimal(100));
    ...
    void withdraw() {
        ...
        // Calling the method
        commandLineATMService.withdraw(user, new BigDecimal(100));
    ...
    void peerToPeer() {
        ...
        // Calling the method
        commandLineATMService.peerToPeer(sender, receiver, new BigDecimal(100));
